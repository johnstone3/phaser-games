...
export class WinScene extends Phaser.Scene {
    ...
    create(): void {
        ...
        this.add.text(this.sys.game.config.width as number / 2, (this.sys.game.config.height as number / 2) + 200, 'Kliknite pre hru znovu', { // Adjusted y position
            fontSize: '18px',
            fill: '#3498db' // Light blue
        }).setOrigin(0.5);
